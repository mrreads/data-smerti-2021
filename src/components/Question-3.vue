            ...
            <div class="questions-wrapper">
                ...
                <div class="select-wrapper">
                    ...
                    <div class="select-dropdown" v-if="expandMonth">
                        <p v-for="index in month" :key="index" @click="selectedMonth = index, expandMonth = false; check()"> {{ index }}</p>
                    </div>
                </div>
                ...
                <div class="select-wrapper">
                    ...
                    <div class="select-dropdown" v-if="expandYear">
                        <p v-for="(index) in yearRange(1900, 2020)" :key="index" @click="selectedYear = index, expandYear = false; check()"> {{ index }}</p>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        {
            return new Array(stop-start).fill(start).map((n,i)=>n+i).reverse();
        }
    }
}
</script>
